...
namespace VideoStore
{
    class Program
    {
        ...
        private static Store _videoStore = new Store();
        ...
        private static void FillVideoStore()
        {
            for (var i = 0; i < CountOfMovies; i++)
            {
                ...
                _videoStore.TakeUserRating(rating, movieName);
        ...
        {
            Console.WriteLine("Enter movie name to rent: ");
            string movieName = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter movie name to return: ");
            string movieName = Console.ReadLine();
